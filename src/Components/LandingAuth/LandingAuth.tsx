...
function LandingAuth() {
  ...
  const { loginUser } = useNetworkAuth();
    ...
    try {
      ...
      useEffect(() => {
        ...
        fetchID({
          ...
          if (userLoading === false && userID?.User?.length === 0) {
  ...
  useEffect(() => {
    fetchProposals({ variables: { username: user?.nickname } });
    fetchRecommendedProposals({ variables: { username: user?.nickname } });
    fetchRecommendedProposers({ variables: { username: user?.nickname } });
    fetchMentoringProposals({ variables: { username: user?.nickname } });
    fetchRecommendedMentors({ variables: { username: user?.nickname } });
  ...
  return (
    <Box>
      ...
      /> */}
      <Box sx={{ width: '75%', margin: 'auto', marginTop: '12px' }}>
        ...
        <Box>
          ...
          <Grid container className={Style.cardContainer}>
            ...
            <Grid
              ...
              sx={{ padding: '7px', maxHeight: '358px', marginBottom: { xs: '20px' } }}
            >
          ...
          <Grid container className={Style.cardContainer}>
            ...
            <Grid item xs={12} md={4} sx={{ maxHeight: '140px', paddingBottom: '25px' }}>
              ...
              <Box
                ...
                sx={{ marginBottom: { xs: '300px' }, padding: '10px', maxHeight: { sm: 'none', md: '175px' }, marginTop: '35px' }}
              >
