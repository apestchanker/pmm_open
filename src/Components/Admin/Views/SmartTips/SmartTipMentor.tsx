...
function SmartTipMentor() {
  ...
  return (
    <Grid container spacing={3} sx={{ position: 'relative', width: '80%', margin: 'auto', p: { xs: 1, md: 10 }, pt: { xs: 5, md: 10 } }}>
      ...
      <Typography sx={{ fontSize: '24px', fontWeight: 'bold', width: '100%', lineHeight: '16px' }}>Smart tips choosing a mentor</Typography>
