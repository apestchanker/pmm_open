...
import { GET_TASK_SKILLS } from 'Queries/adminQueries';
import Row from './RowSkills';
...
const SkillsView = () => {
  ...
  const [fetchSkills, { data: dataSkills }] = useLazyQuery(GET_TASK_SKILLS, {
