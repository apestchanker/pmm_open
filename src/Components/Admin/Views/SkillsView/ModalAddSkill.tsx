...
import { ADD_TASK_SKILLS } from 'Queries/adminQueries';
...
const ModalAddSkill = () => {
  ...
  const [addTaskSkill, { error }] = useMutation(ADD_TASK_SKILLS, {
    variables: {
      data: {
        id: values.id,
        name: values.name,
    ...
    <>
      ...
      <Modal open={open} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
        <Box sx={style}>
          ...
          <Button sx={{ width: '75px', bgcolor: 'rgba(38, 53, 96, 1)', mt: 2 }} variant="contained" onClick={handleAddTaskSkill}>
            ADD
          </Button>
        </Box>
      </Modal>
